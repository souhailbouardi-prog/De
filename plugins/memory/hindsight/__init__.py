...
def _resolve_bank_id_template(template: str, fallback: str, **placeholders: str) -> str:
    ...
    try:
        ...
        return fallback
    # Collapse repeated separators left over from empty substitutions
    # (e.g. "hermes--user" -> "hermes-user") and trim edges.
    while "--" in rendered:
...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        # Identity (from initialize kwargs — used for bank_id_template resolution)
        self._platform = ""
        self._user_id = ""
