...
class TestSQLiteMemoryPlugin:
    ...
    def test_multiple_external_plugins_accepted(self):
        """Multiple external memory providers can run simultaneously."""
        mgr = MemoryManager()
        ...
        assert mgr.provider_names == ["sqlite_memory", "sqlite_memory_2"]
