...
description: "High-performance RLHF framework with Ray+vLLM acceleration. Use for\
  \ PPO, GRPO, RLOO, DPO training of large models (7B-70B+). Built on Ray, vLLM, ZeRO-3.\
  \ 2\xD7 faster than DeepSpeedChat with distributed architecture and GPU resource\
  \ sharing."
version: 1.0.0
...
metadata:
  hermes:
    category: research/orchestra/06-post-training
    tags:
    - Post-Training
    - OpenRLHF
    - RLHF
