...
description: Comprehensive guide for writing systems papers targeting OSDI, SOSP,
  ...
  patterns, venue-specific checklists, reviewer guidelines, LaTeX templates, and conference
  deadlines. Use this skill for all systems conference paper writing.
version: 1.0.0
