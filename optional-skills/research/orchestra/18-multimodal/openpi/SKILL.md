...
description: Fine-tune and serve Physical Intelligence OpenPI models (pi0, pi0-fast,
  ...
  and LIBERO environments. Use when adapting pi0 models to custom datasets, converting
  JAX checkpoints to PyTorch, running policy inference servers, or debugging norm
  stats and GPU memory issues.
version: 1.0.0
