...
description: Fine-tunes and evaluates OpenVLA-OFT and OpenVLA-OFT+ policies for robot
  ...
  on LIBERO simulation and ALOHA real-world setups. Use when reproducing OpenVLA-OFT
  paper results, training custom VLA action heads (L1 or diffusion), deploying server-client
  inference for ALOHA, or debugging normalization, LoRA merge, and cross-GPU issues.
version: 1.0.0
...
metadata:
  hermes:
    category: research/orchestra/18-multimodal
    tags:
    - OpenVLA
    - OpenVLA-OFT
    - VLA
