...
description: Applies cognitive science frameworks for creative thinking to CS and
  AI research ideation. Use when seeking genuinely novel research directions by leveraging
  combinatorial creativity, analogical reasoning, constraint manipulation, and other
  empirically grounded creative strategies.
version: 1.0.0
...
metadata:
  hermes:
    category: research/orchestra/21-research-ideation
    tags:
    - Creative Thinking
    - Research Ideation
